...
public class Account_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ket = (TextView)findViewById(R.id.Logout_txt);
        ...
        if (ContextCompat.checkSelfPermission(Account_edit.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    //Toast.makeText(Account_edit.this, "Image Saved!", Toast.LENGTH_SHORT).show();
                    ShowSelectedImage.setImageBitmap(FixBitmap);
                    UploadImageOnServerButton.setVisibility(View.VISIBLE);
                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(Account_edit.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = ProgressDialog.show(Account_edit.this,"Image is Uploading","Please Wait",false,false);
            }
                    ...
                    try {
                        ...
                        if(!(jsonObject.getString("message").equals(""))){
                            if(jsonObject.getString("error").equals("false")){
                                ...
                                Toast.makeText(getApplicationContext(), "Berhasil Edit", Toast.LENGTH_SHORT).show();
                                finish();
                            }else{
            ...
            protected String doInBackground(Void... params) {
                final String Namalengkap, Username, Password, Password0, Alamat, Notlpn, Email, Level, Ket;
                Namalengkap = namalengkap.getText().toString().trim();
                Username = username.getText().toString().trim();
                Password = password.getText().toString().trim();
                Password0 = password0.getText().toString().trim();
                ...
                HashMapParams.put("id_account", Ket);
                ...
                String FinalData = imageProcessClass.ImageHttpRequest("http://prores.000webhostapp.com/account_edit", HashMapParams);
                return FinalData;
            }
        }
    ...
    public void load_data(){
        ...
        if(!id_account.equals("")){
            StringRequest stringRequest = new StringRequest(Request.Method.POST, MySingleton.account_detail,
                            ...
                            try {
                                ...
                                if(!(jsonObject.getString("message").equals(""))){
                                    if(jsonObject.getString("error").equals("false")){
                                        ...
                                        ket.setText("ACCOUNT EDIT "+data.getString("id_account"));
                                        namalengkap.setText(data.getString("nama_lengkap"));
                                        username.setText(data.getString("username"));
                                        password.setText(data.getString("password"));
                                        password0.setText(data.getString("password"));
                                        alamat.setText(data.getString("alamat"));
                                        notlpn.setText(data.getString("notlpn"));
                                        email.setText(data.getString("email"));
                                        if(data.getString("level").equalsIgnoreCase("manager")){
                                            level.setSelection(2);
                                        }else if(data.getString("level").equalsIgnoreCase("staff")){
            ...
            MySingleton.getInstance(Account_edit.this).addToRequestQueue(stringRequest);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(Account_edit.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
            }
        }
    }
}