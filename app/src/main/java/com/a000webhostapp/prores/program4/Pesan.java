...
public class Pesan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pesan_listFragment.cetak("", "input");
            ...
            public void onClick(View v) {
                if(submit.getText().toString().equalsIgnoreCase("PESAN")){
                    ...
                    if(temp.size() > 0){
                        ...
                        Toast.makeText(Pesan.this, "Harap Pilih Pesanan", Toast.LENGTH_LONG).show();
                    }
                }else if(submit.getText().toString().equalsIgnoreCase("KONFIRM")){
                    jenis = checkoutFragment.get_jenis();
                    pmbyrn = checkoutFragment.get_pmbyrn();
                    meja = checkoutFragment.get_meja();
                    ...
                    mRequestQueue = MySingleton.getInstance(Pesan.this).getRequestQueue();

                    StringRequest stringRequest = new StringRequest(Request.Method.POST, MySingleton.pesan,
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            params.put("pembayaran", pmbyrn);
                            params.put("meja", meja);
                            return params;
                        }
                    };
                    MySingleton.getInstance(Pesan.this).addToRequestQueue(stringRequest);
                }
            }
        });
